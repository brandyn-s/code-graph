...
func (s *Server) handleIndexStatus(_ context.Context, req *mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	...
	// Accuracy band. Measured empirically via bench/accuracy/, most recently on
	// 2026-08-12. Surfacing these on every
	...
	result["known_accuracy"] = map[string]any{
		...
		"method":                   "edge-level F1 vs independent language/compiler oracles, scope-aligned",
		...
		"typescript_imports_f1":    "1.000 (456 TP, 0 FP, 0 FN across ky and Chainlit frontend compiler-program scopes)",
		"imports_caveats":          "TypeScript result covers measured project-local static imports/re-exports; Python 0.94-0.96 after nested-resolver fix; Go ungraded; Rust sparse on use crate:: paths",
