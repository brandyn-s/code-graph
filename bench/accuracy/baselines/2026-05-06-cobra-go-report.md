...
|---|---|---|---|---|---|---|
| CALLS | go-ast | 906 / 1585 | 0.565 / 0.988 / 0.719 | 0.896 / 0.988 / 0.940 | 0.896 / 0.988 / 0.940 | 0.896 / 0.988 / 0.940 |
...
|---|---|---:|---:|---:|---:|---:|---:|
| cobra | 906 / 1585 | 895 | 563 | 11 | 0.614 | 0.988 | **0.757** |

**Spread**: min F1 = 0.757, max F1 = 0.757, range = 0.000
...
| `method-body` | 288 | 58 | 0.832 | 346 |
| `test-body` | 462 | 0 | 1.000 | 462 |

**Package-block caller FP rate**: 0.0000 (0 of 104 FPs)

**Caller-kind complement legitimacy** (function/method-body share of all scope-aligned edges): 0.5317 (537 of 1010)
...
|---|---:|---:|---:|---:|
| `ambiguous` | 1 | 1 | 0.5000 | 2 |
| `unambiguous` | 894 | 103 | 0.8967 | 997 |

**janusian_precision_gap** (unambiguous − ambiguous precision): +0.3967. Positive = unambiguous sites resolve more accurately, consistent with Step 2's prediction. Negative or near-zero = ambiguity is not the dominant FP driver.
