...
|---|---|---|---|---|---|---|
| CALLS | pycg | 194 / 194 | 0.273 / 0.273 / 0.273 | 0.697 / 0.273 / 0.393 | 0.697 / 0.273 / 0.393 | 0.697 / 0.273 / 0.393 |
| IMPORTS | ast | 55 / 26 | 0.077 / 0.036 / 0.049 | 1.000 / 0.036 / 0.070 | 1.000 / 0.036 / 0.070 | 1.000 / 0.036 / 0.070 |
...
|---|---:|---:|---:|---:|
| `method-body` | 45 | 19 | 0.703 | 64 |

**Package-block caller FP rate**: 0.0000 (0 of 23 FPs)

**Caller-kind complement legitimacy** (function/method-body share of all scope-aligned edges): 0.3502 (76 of 217)
...
|---|---:|---:|---:|
| __all__ | 10 | 43 | 0.2326 |

**janusian_site_precision_split** — precision conditional on call-site ambiguity:

| Bucket | TP | FP | Precision | Support |
|---|---:|---:|---:|---:|
| `ambiguous` | 1 | 12 | 0.0769 | 13 |
| `unambiguous` | 52 | 11 | 0.8254 | 63 |

**janusian_precision_gap** (unambiguous − ambiguous precision): +0.7485. Positive = unambiguous sites resolve more accurately, consistent with Step 2's prediction. Negative or near-zero = ambiguity is not the dominant FP driver.
...
|---|---|---|---|---|
| real_only | 194 | 0.273 / 0.273 / 0.273 | 0.276 / 0.273 / 0.275 | 0.697 / 0.273 / 0.393 |
| real_plus_external | 194 | 0.273 / 0.273 / 0.273 | 0.276 / 0.273 / 0.275 | 0.697 / 0.273 / 0.393 |
| real_plus_pseudo | 194 | 0.273 / 0.273 / 0.273 | 0.276 / 0.273 / 0.275 | 0.697 / 0.273 / 0.393 |
| all_calls_family | 194 | 0.273 / 0.273 / 0.273 | 0.276 / 0.273 / 0.275 | 0.697 / 0.273 / 0.393 |
...
```
  ...
  src.requests.models.PreparedRequest.prepare_content_length --> src.requests.cookies.RequestsCookieJar.get
  ...
  src.requests.models.Response.links --> src.requests.cookies.RequestsCookieJar.get
...
```
  ...
  src.requests.models.PreparedRequest.__init__ --> src.requests.hooks.default_hooks
  src.requests.models.PreparedRequest.copy --> src.requests.cookies._copy_cookie_jar
  ...
  src.requests.models.PreparedRequest.prepare_auth --> src.requests.utils.get_auth_from_url
...
```
  ...
  src.requests.adapters.HTTPAdapter.get_connection_with_tls_context --> src.requests.adapters.HTTPAdapter.build_connection_pool_key_attributes
  src.requests.adapters.HTTPAdapter.get_connection_with_tls_context --> src.requests.adapters.HTTPAdapter.proxy_manager_for
```
