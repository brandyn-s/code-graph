...
|---|---|---|---|---|
| Core CI | `core-ci.yml` | pull_request, push to `main` | none | Lint against the reviewed baseline, `go test` on Linux, macOS, and Windows, production build and smoke test, shell lint, schema drift check, zero-cost agent contract battery, workflow structure tests |
