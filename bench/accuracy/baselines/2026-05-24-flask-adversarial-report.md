...
|---|---|---|---|---|---|---|
| CALLS | pycg | 93 / 182 | 0.302 / 0.591 / 0.400 | 0.775 / 0.591 / 0.671 | 0.775 / 0.591 / 0.671 | 0.775 / 0.591 / 0.671 |
...
|---|---:|---:|---:|---:|
| `method-body` | 47 | 8 | 0.855 | 55 |

**Package-block caller FP rate**: 0.2500 (4 of 16 FPs) ALARM

**Caller-kind complement legitimacy** (function/method-body share of all scope-aligned edges): 0.6055 (66 of 109)
...
| `unambiguous` | 55 | 13 | 0.8088 | 68 |

**janusian_precision_gap** (unambiguous − ambiguous precision): +0.8088. Positive = unambiguous sites resolve more accurately, consistent with Step 2's prediction. Negative or near-zero = ambiguity is not the dominant FP driver.
...
|---|---|---|---|---|
| real_only | 182 | 0.302 / 0.591 / 0.400 | 0.302 / 0.591 / 0.400 | 0.775 / 0.591 / 0.671 |
| real_plus_external | 182 | 0.302 / 0.591 / 0.400 | 0.302 / 0.591 / 0.400 | 0.775 / 0.591 / 0.671 |
| real_plus_pseudo | 182 | 0.302 / 0.591 / 0.400 | 0.302 / 0.591 / 0.400 | 0.775 / 0.591 / 0.671 |
| all_calls_family | 182 | 0.302 / 0.591 / 0.400 | 0.302 / 0.591 / 0.400 | 0.775 / 0.591 / 0.671 |
...
```
  ...
  src.flask.app.Flask.wsgi_app --> src.flask.json.provider.JSONProvider.response
  src.flask.cli --> src.flask.cli.CertParamType
  src.flask.cli --> src.flask.cli.FlaskGroup
  src.flask.cli --> src.flask.cli.SeparatedPathType
  src.flask.cli.FlaskGroup.make_context --> src.flask.cli.ScriptInfo
```
