"""rust-reqwest fixture gate (Phase C1).

Indexes `bench/accuracy/synthetic/rust-reqwest/` and asserts that
each of the three reqwest URL-extraction shapes (literal, const,
format!()) produces an HTTP_CALLS edge to the matching axum handler.
...
FIXTURE_ROOT = REPO_ROOT / "bench" / "accuracy" / "synthetic" / "rust-reqwest"
